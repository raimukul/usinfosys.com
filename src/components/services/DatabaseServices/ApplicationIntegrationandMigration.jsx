        ...
        <Grid container spacing={2} justify="space-between">
          ...
          <Grid item sm={12} md={8} className="m-auto">
            ...
            <Typography>
              ...
              best approaches for utilizing new structured data and/or new
              ...
              platform, or vice versa. These tasks include ensuring proper data
              type conversions and database settings as well as, among other
              things, implementing the appropriate database and table space
              configurations.
            </Typography>
          </Grid>
        </Grid>
