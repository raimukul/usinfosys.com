          ...
          <Grid container spacing={2} justify="space-between">
            ...
            <Grid item sm={12} md={8}>
              ...
              <Typography>
                ...
                utilization patterns, memory sizing and consumption, and
                carefully examine your use of database indices and the
                appropriateness of your index types.
                <br />
                Once we’ve carried out a full analysis, we work with your system
                administrators, DBA’s, and developers to come to a cost
                effective and expedient performance enhancing solution.
                Additionally we offer customized training session for your DBA
                and/or development staff, focusing on proper index tuning, SQL
                evaluation, and SQL tuning techniques.
              </Typography>
            </Grid>
